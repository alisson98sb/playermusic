export function Player2() {
  return (
    <div>
      <div className="header-player-2">
        <img
          src="https://images.pexels.com/photos/1234853/pexels-photo-1234853.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500"
          alt=""
        />
        <div className="title-player-2">
          <h1 className="music">Acorda Devinho</h1>
          <p className="band">Banda DevOlva</p>
        </div>
      </div>
      <div id="control-player-2" className="control-player">
        <div className="prev">
          <button>
            <svg
              width="30"
